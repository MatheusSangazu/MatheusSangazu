...
<a href="https://www.linkedin.com/in/mths-alves/" target="_blank">
  <img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-mths--alves-0077B5?style=for-the-badge&logo=linkedin&logoColor=white">
</a>
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🤖 Torrinco — Agente Financeiro com IA</h3>
      <p>Agente de IA financeiro com PWA para gestão financeira via WhatsApp. Transcrição de áudios, processamento de boletos via OCR, registro automático de transações e interface web. Construído do zero.</p>
      ...
      <img alt="Evolution API" src="https://img.shields.io/badge/-Evolution_API-FF6B00?style=flat-square&logo=whatsapp&logoColor=white" />
      <br><br>
      <a href="https://github.com/MatheusSangazu/Torrinco">🔗 Repositório</a>
    </td>
    <td width="50%" valign="top">
      <h3>💳 BeTalent Payment API</h3>
      <p>Core API multi-gateway com arquitetura baseada em Adapter Pattern. Implementação rigorosa de TDD e Fallback Automático para alta disponibilidade em processamentos de pagamento.</p>
      <strong>Status:</strong> Concluído ✅
      <br><br>
      <img alt="Node.js" src="https://img.shields.io/badge/-Node.js-339933?style=flat-square&logo=node.js&logoColor=white" />
      <img alt="AdonisJS" src="https://img.shields.io/badge/-AdonisJS-5A45FF?style=flat-square&logo=adonisjs&logoColor=white" />
      <img alt="MySQL" src="https://img.shields.io/badge/-MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white" />
      <img alt="TDD" src="https://img.shields.io/badge/-TDD-2596BE?style=flat-square&logo=testin&logoColor=white" />
      <br><br>
      <a href="https://github.com/MatheusSangazu/betalent-payment-api">🔗 Repositório</a>
    </td>
  </tr>

  <tr>
    <td width="50%" valign="top">
      <h3>🎉 Check Fácil — Gestão de Eventos</h3>
      <p>PWA para gestão completa de festas infantis. Check-in em tempo real, disparos automáticos via Evolution API, rate limiting e autenticação JWT. Monorepo com frontend React e API Node.js.</p>
      <strong>Status:</strong> Em Desenvolvimento 🏗️
      <br><br>
    ...
    <td width="50%" valign="top">
      <h3>📊 Ads Data Pipeline</h3>
      <p>Middleware ETL de alto rendimento. Orquestração de métricas do Meta Ads com persistência em MySQL e infraestrutura conteinerizada em K3s (Kubernetes leve).</p>
      ...
      <img alt="Docker" src="https://img.shields.io/badge/-Docker-2496ED?style=flat-square&logo=docker&logoColor=white" />
      <br><br>
      <a href="https://github.com/MatheusSangazu/growth-ads-data-pipeline">🔗 Repositório</a>
    </td>
  </tr>

  <tr>
    <td width="50%" valign="top">
      <h3>🛠️ Canivete Suíço — Engenharia de Dados</h3>
      <p>Kit de ferramentas para higienização massiva de leads. Processamento assíncrono de arquivos, segmentação inteligente e automação de pipelines de mídia com FFmpeg.</p>
      <strong>Status:</strong> Concluído ✅
      <br><br>
      ...
      <img alt="Docker" src="https://img.shields.io/badge/-Docker-2496ED?style=flat-square&logo=docker&logoColor=white" />
      <br><br>
      <a href="https://github.com/MatheusSangazu/formatador">🔗 Repositório</a> · <a href="https://formatador.forjacorp.com/">🌐 Live</a>
    </td>
    <td width="50%" valign="top">
      <h3>🌎 CLIHC 2026 — Conferência Internacional</h3>
      <p>Arquitetura frontend para conferência internacional Latino-Americana. Implementação de i18n complexo (múltiplos idiomas) e deploy automatizado via GitHub Pages.</p>
      <strong>Status:</strong> Em Produção 🚀
      <br><br>
      <img alt="Vue.js" src="https://img.shields.io/badge/-Vue.js-4FC08D?style=flat-square&logo=vue.js&logoColor=white" />
      <img alt="JavaScript" src="https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" />
      <img alt="i18n" src="https://img.shields.io/badge/-i18n-7B42BC?style=flat-square&logo=translate&logoColor=white" />
      <img alt="GitHub Pages" src="https://img.shields.io/badge/-GitHub_Pages-181717?style=flat-square&logo=github&logoColor=white" />
      <br><br>
